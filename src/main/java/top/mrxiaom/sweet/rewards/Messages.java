...
public enum Messages implements IHolderAccessor {
    ...
    commands__reload_player_close_inv("&e管理员重载了插件配置，请重新打开菜单"),
    ...
    commands__reset__not_found("&e找不到这个菜单"),
    commands__reset__player_close_inv("&e管理员重置了你的奖励领取情况，请重新打开菜单"),
    commands__reset__success("&a你已重置玩家&e %player% &a在菜单&e %rewards% &a的奖励领取情况"),
    commands__reset__success_all("&a你已重置所有玩家在菜单&e %rewards% &a的奖励领取情况"),
    ...
    commands__help__admin("",
            ...
            "&f/rewards reset <菜单ID> <玩家/--all> &7重置某人或所有玩家的奖励领取情况",
